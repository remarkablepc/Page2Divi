...
WordPress core themes • Gutenberg core blocks • Elementor (live URL + JSON template export) • Beaver Builder • Bricks Builder • WPBakery / Visual Composer • Avada / Fusion • Oxygen • Thrive Architect • Astra theme + Spectra / UAGB blocks • Kadence Blocks • Divi 4 / Divi 5 source pages (with module-level Divi 4 ↔ Divi 5 translation) • Wild Apricot • Duda • Clicksites.ai • WooCommerce product pages • CMS Made Simple • GetSimple CMS • Joomla • Drupal • Wix / Squarespace / Webflow / HubSpot / Bootstrap‑based pages • plain hand‑rolled HTML.
